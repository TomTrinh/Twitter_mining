...
if (! file.exists('tweets.zip')) download.file(dataURL, 'tweets.zip')#download zipfile
if (! file.exists('tweets.dbf')) unzip('tweets.zip')#unzip
tweets = read.dbf('tweets.dbf', as.is = TRUE)#reading tweets file
